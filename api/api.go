...
// The server mux from the standard http package is really good
// gorilla package adds method based routes and path variables.
...
func (s *Server) routes() {
	s.HandleFunc("/shoping-items", s.listShoppingItems()).Methods("GET")
...
func (s *Server) createShoppingItem() http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		i.ID = uuid.New()
		s.shoppingItems = (s.shoppingItems, i)
